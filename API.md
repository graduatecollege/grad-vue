...
Components support CSS custom properties for theming. Common variables include:
- `--g-toolbar-height` - Toolbar height for offset calculations
- `--g-detail-list-item-min-width` - Detail list item minimum width
- `--g-detail-list-item-max-width` - Detail list item maximum width
- `--v-gtooltip-arrow-x` - Tooltip arrow position (set automatically)
