    ...
    <ComponentSection title="App Header">
        <ComponentDemo
            ...
            :props-config="{
                ...
                navigationLabel: {
                    type: 'string',
                    label: 'Accessible label for the main navigation',
                    default: 'Main navigation'
                },
                navigationMediaQuery: {
                    type: 'string',
                    label: 'Media query for when the main navigation should collapse',
...
<p><strong>Slot</strong> <code>title</code> is to the right of the logo.</p>
<p><strong>Slot</strong> <code>navigation</code> shows a short set of main navigation links. On small
screens it automatically switches to a popover menu.</p>
