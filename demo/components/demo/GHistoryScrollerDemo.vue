...
<span class="line"><span style="color:#008000">    /**</span></span>
<span class="line"><span style="color:#008000">     * History entries passed to default slot</span></span>
<span class="line"><span style="color:#008000">     */</span></span>
<span class="line"><span style="color:#001080">    entries</span><span style="color:#000000">: </span><span style="color:#267F99">T</span><span style="color:#000000">[];</span></span>
<span class="line"><span style="color:#000000">};</span></span></code></pre>
</figure>

</template>
            <template #docs><p>A scroller that is used for content that&#39;s typically shown like a chat log,
meaning it starts at the bottom, and you scroll up for older entries.</p>
<p>The scroller automatically starts at the bottom. When scrolled up, a button
appears that jumps to the bottom. This button is also the first focusable
element for accessibility.</p>
<p>If the <code>label</code> is provided, the scroller will have the ARIA <code>role=&quot;log&quot;</code> and
the label as the <code>aria-label</code>.</p>
<p><strong>Slot</strong> <code>default</code> is what will be rendered for each entry in the
<code>entries</code>. For example:</p>
<figure class="highlighted-code">
<pre class="shiki light-plus" style="background-color:#FFFFFF;color:#000000" tabindex="0"><code><span class="line"><span style="color:#800000">&#x3C;</span><span style="color:#267F99">GHistoryScroller</span></span>
